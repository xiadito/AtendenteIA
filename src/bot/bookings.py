...
def create_booking_with_lock(
    ...
    Args:
        ...
        lead_name (str): Lead's name, as provided by the AI.
            ...
            try:
                cur.execute(
                    ...
                    INSERT INTO trial_bookings
                        (id, tenant_id, sender, lead_name, calendar_event_id, class_type, slot_start, slot_end, status)
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, 'pending_confirmation')
                    """,
                    (booking_id, tenant_id, sender, lead_name, calendar_event_id, class_type, slot_start, slot_end),
                )
